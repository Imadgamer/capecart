      ...
      <div className="space-y-4">
        <Card className="p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-heading font-semibold">Account Info</h3>
          </div>
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between"><span className="text-muted-foreground">Last Sign In</span><span className="font-medium">{user?.last_sign_in_at ? new Date(user.last_sign_in_at).toLocaleDateString() : "N/A"}</span></div>
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-heading font-semibold">Password</h3>
          </div>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-heading font-semibold">Active Sessions</h3>
          </div>
          <div className="text-sm text-muted-foreground">
            <p>Current session is active on this device</p>
          </div>
        </Card>
      </div>
    </div>
